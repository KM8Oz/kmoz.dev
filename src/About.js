...
const useStyles = makeStyles(theme => ({
    cont: {
        minHeight: `calc(80vh - ${theme.spacing(4)}px)`,
        alignSelf: 'center',
        justifySelf: 'center'
    },
    avatar: {
...
export default function About() {
    ...
    return(
        <Grid direction="row" container justify="space-around" alignItems="center" className={classes.cont}>
                        ...
                        <Grid item key={i}>
                            <a href={link} target="_blank" rel="noopener noreferrer">
                                <Tooltip title={alt} placement="top">
                                    <Avatar variant="square" className={clsx([classes.avatar, classes[alt]])}>
                                        {icon}
                                    </Avatar>
                                </Tooltip>
                            </a> 
